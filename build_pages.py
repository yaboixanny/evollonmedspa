...
<body data-treatment="{escape(key)}">
  ...
  <main>
    ...
    <section class="consult-section" id="consultation"><div class="wrap consult-grid"><div class="consult-copy"><div class="eyebrow">LET'S TALK</div><h2>Your next step starts <em>here.</em></h2><p>Have a question about {escape(d['name'])}? Tell us a little about yourself. This form opens a text message to Evollon so you can send your request directly.</p><div class="contact-line"><span aria-hidden="true">⌖</span><div><strong>Visit us in Forest Hills</strong><br>105-09 Metropolitan Ave, Ste 2<br>Forest Hills, NY 11375</div></div></div><form class="form-card" id="lead-form" aria-label="Ask about {escape(d['name'])}"><div class="form-title">Ask about {escape(d['name'])}<span>We'll help you take the next step.</span></div><label for="full-name">Full name <span class="required">*</span></label><input id="full-name" name="name" autocomplete="name" required placeholder="Full name"><label for="email">Email <span class="required">*</span></label><input id="email" name="email" type="email" autocomplete="email" required placeholder="Email"><label for="phone">Phone <span class="required">*</span></label><input id="phone" name="phone" type="tel" autocomplete="tel" inputmode="tel" required placeholder="Phone"><button class="button button-primary submit" type="submit">{'I want $100 off.' if key == 'botox' else 'Continue to text request'}</button><p class="form-fine">Your information is added to a text draft. Your message is sent only when you send it from your device.</p><div class="form-result" id="form-result" role="status" hidden></div></form></div></section>
